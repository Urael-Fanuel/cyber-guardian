...
async function resolveSupportedSource(classification) {
  ...
  // A truncated tree means GitHub omitted files — scanning would produce a partial and potentially false-clean verdict
  if (tree.truncated) throw new Error("This repository is too large for a complete automatic scan. Please scan a specific subdirectory or file instead.");
